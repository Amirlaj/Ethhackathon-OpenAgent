...
/**
 * CLI: Register a new agent as an ENS subname under agentmesh.eth
 *
 * Usage:
...
public class RegisterAgent {
    ...
    private static final String PARENT_DOMAIN = "agentmesh.eth";
    ...
    public static void main(String[] args) throws Exception {
        ...
        String ensName = label + "." + PARENT_DOMAIN;
        ...
        System.out.println("✓ Manifest validated");
        ...
        textClient.registerSubname(label, PARENT_DOMAIN, ownerAddress);
        System.out.println("✓ Subname registered: " + ensName);
        ...
        System.out.println("✓ Text records set");
        ...
        System.out.println("✓ Verified: " + resolved.ensName() + " → " + resolved.endpoint());
        System.out.println();
        System.out.println("Agent registered successfully!");
        System.out.println("Start it with: ENS_NAME=" + ensName + " mvn spring-boot:run -pl agent-runtime");
